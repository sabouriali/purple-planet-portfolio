...
function Navbar() {
  ...
  return (
    <div className="z-50 fixed flex justify-center w-full text-white font-bold">
      <div className="border border-white/20 mt-8 backdrop-blur-3xl rounded-3xl hidden md:flex items-center justify-center p-2 mx-auto max-w-[400px]">
      ...
      <div
        onClick={toggleNav}
        className="md:hidden fixed top-5 right-14 border rounded z-50 text-white/70 p-2"
      >
