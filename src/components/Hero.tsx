...
function Hero() {
  return (
    <div className="relative overflow-clip min-h-screen text-white bg-[linear-gradient(to_bottom,#000,#340F41_35%,#8A3DA4_55%,#B993ED_85%)]">
      <div className="absolute bg-black w-[2400px] h-[1000px] rounded-[50%] left-1/2 -translate-x-1/2 bg-[radial-gradient(closest-side,#000_85%,#9E4AC5)] top-[450px] border border-[#BD8CDE]/30" />
      <div className="container relative mx-auto px-4 pt-12 pb-24">
        <div className="flex flex-col items-center justify-center text-center z-10">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-b from-purple-500/40 to-transparent rounded-full blur-3xl" />
            <Image
              src={profilePic}
              alt="profile pic"
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              <motion.button
                ...
                className="px-6 py-3 bg-gradient-to-r from-purple-700 to-purple-500 rounded-full font-medium hover:bg-purple-700 transition-colors"
              >
                Contact Me
              </motion.button>
              <motion.button
